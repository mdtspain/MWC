...
BitcoinGUI::BitcoinGUI(QWidget *parent):
    ...
    rpcConsole(0)
	{
	    ...
	    setWindowTitle(tr("MultiWallet") + " - " + tr("Wallet"));
    ...
    {
        progressBar->setStyleSheet("QProgressBar { background-color: #e8e8e8; border: 1px solid black; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::solid { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #FF8000, stop: 1 orange); border-radius: 7px; margin: 0px; }");
    }
...
void BitcoinGUI::createActions()
{
    ...
    blockAction->setToolTip(tr("Explore the MultiWallet Blockchain"));
...
void BitcoinGUI::createToolBars2()
{
   ...
   mylabel->show();
    ...
    "#toolbar { font-weight:600;border:1;height:100%;padding-top:20px; padding:0 15px; background: rgb(115,115,115); text-align:center; color: white;min-width:180px;max-width:180px;}" //menu
