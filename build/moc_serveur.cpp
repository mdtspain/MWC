...
static const char qt_meta_stringdata_Serveur[] = {
    "Serveur\0pseudoChanged(QString)\0newPseudo\0"
    "\0joinTab()\0tabJoined()\0readServeur()\0"
    "errorSocket(QAbstractSocket::SocketError)\0"
    "connected()\0joins()\0sendData(QString)\0"
    "txt\0join(QString)\0chan\0leave(QString)\0"
    "ecrire(QString,QString,QString)\0"
    "txt,destChan,msgTray\0ecrire(QString,QString)\0"
    "txt,destChan\0ecrire(QString)\0"
    "updateUsersList(QString,QString)\0"
    "chan,message\0updateUsersList(QString)\0"
    "updateUsersList()\0"
};
