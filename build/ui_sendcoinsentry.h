...
public:
    ...
    void setupUi(QFrame *SendCoinsEntry)
    {
        ...
        fromAddress->setSizePolicy(sizePolicy);
    ...
    void retranslateUi(QFrame *SendCoinsEntry)
    {
        ...
        label_3->setText(QApplication::translate("SendCoinsEntry", "Sending From:", 0, QApplication::UnicodeUTF8));
        fromAddress->setText(QString());
        ...
        cloaksendButton->setText(QApplication::translate("SendCoinsEntry", "MultiShift", 0, QApplication::UnicodeUTF8));
        label_5->setText(QApplication::translate("SendCoinsEntry", "(Generate Anon Send Address)", 0, QApplication::UnicodeUTF8));
